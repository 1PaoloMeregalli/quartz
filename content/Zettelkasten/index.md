...
La mia vita non è a compartimenti stagni.
Mentre cerco di capire un ciclo `for` in Python, magari sto pensando ai tempi di lievitazione della pizza per stasera, o a una posizione di Yoga che mi ha sciolto la schiena, o a quella notizia letta sul giornale che mi ha fatto arrabbiare. 
...
> [!quote] Il concetto base
> Un'idea, una nota. Piccola, essenziale, collegata.

Qui dentro potresti trovare:
* Un appunto veloce su una libreria Python che mi ha fatto impazzire.
* Una riflessione flash su una notizia di attualità.
* Il motivo per cui *quella* farina è meglio dell'altra (scientificamente provato).
* Una citazione di un libro che non volevo dimenticare.

### Come navigare in questo labirinto
