...
Ho smesos di scrivere post per qualche anno. Mi ero stancato dei soliti siti, delle solite strutture, di quel dover rincorrere il tempo che è la condanna di questa era.
...
***
### La diagnosi
Credo di essere affetto da quella che chiamano **[Multipotenzialità](https://it.wikipedia.org/wiki/Multipotenzialit%C3%A0)**. Lo scrivo con una certa riluttanza. Ho il forte sospetto che sia un termine coniato da qualche esperto di marketing in cerca di _hype_: suona bene, fa "figo", eppure nasconde insidie faticose. Chi vive questa condizione non si sente speciale, si sente spesso smarrito. È la fatica di chi vorrebbe percorrere tutte le strade contemporaneamente, mentre il mondo ti chiede ossessivamente di sceglierne una sola.
...
Cercando in rete, ho capito che non serviva un altro sito, ma un cambio di paradigma. Ho scelto il **Digital Garden**. Se il blog tradizionale è un fiume – un flusso cronologico di notizie che scorrono via e invecchiano in fretta – il giardino digitale è un luogo fisico, topologico. **È uno spazio dove il tempo non è una linea retta, ma un ciclo.**
